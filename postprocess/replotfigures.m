...
% % 
% % %Validation figures
% % x1=load('output/figures/Fraction_of_calorie_production_available_as_food_validationsetBRA_crops_2020_SavedFigureData');
% % x2=load('output/figures/Fraction_of_calorie_production_available_as_food_validationsetBRA_compare_crops_2020_SavedFigureData');
% % 
% % NSS=x1.NSS;
% % NSS.MakePlotDataFile='off';
% % MakeNiceRegionalFigs(x1.OS.Data,'BRA',NSS,'fraccaloriprodbrazilIBGE');
% % NSS=x2.NSS;
% % NSS.MakePlotDataFile='off';
% % MakeNiceRegionalFigs(x2.OS.Data,'BRA',NSS,'fraccaloriprodbrazilCompareCrops');
% % 
% % 
% % %Validation figures
...
% % MakeNiceRegionalFigs(x1.OS.Data,'CONUS',NSS,'fraccaloriprodUSANASS');
% % 
% % NSS=x2.NSS;
% % NSS.MakePlotDataFile='off';
% % NSS=rmfield(NSS,'logicalinclude')
% % 
% % MakeNiceRegionalFigs(x2.OS.Data,'CONUS',NSS,'fraccaloriprodUSACompareCrops');
